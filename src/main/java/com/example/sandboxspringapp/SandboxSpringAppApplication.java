...
public class SandboxSpringAppApplication {
    public static void main(String[] args) {
        ConfigurableApplicationContext context = SpringApplication.run(SandboxSpringAppApplication.class, args);
        String [] bdn = context.getBeanDefinitionNames();
        for (String s : bdn) {
            if (s.contains("BeanPostProcessor")) {
                System.out.println();
